...
class MaterialPageRouteOpactity<T> extends PageRoute<T>
    with MaterialRouteTransitionMixin<T> {
  /// Construct a MaterialPageRouteOpactity whose contents are defined by [builder].
  ///
  /// The values of [builder], [maintainState], and [PageRoute.fullscreenDialog]
  /// must not be null.
  MaterialPageRouteOpactity({
...
/// See also:
///
///  * [MaterialPageRouteOpactity], which is the [PageRoute] version of this class
class MaterialPage<T> extends Page<T> {
  ...
  Route<T> createRoute(BuildContext context) {
    return _PageBasedMaterialPageRouteOpactity<T>(
        page: this, allowSnapshotting: allowSnapshotting);
  }
}

// A page-based version of MaterialPageRouteOpactity.
//
// This route uses the builder from the page to build its content. This ensures
// the content is up to date after page updates.
class _PageBasedMaterialPageRouteOpactity<T> extends PageRoute<T>
    with MaterialRouteTransitionMixin<T> {
  _PageBasedMaterialPageRouteOpactity({
